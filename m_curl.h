...
static size_t write_to_get_res(void *data, size_t size, size_t nmemb, GET_RES *res)
{
...
int send_http_get(CURL *curl_handle, char *url, GET_RES *res)
{
    ...
    curl_easy_setopt(curl_handle, CURLOPT_WRITEFUNCTION, write_to_get_res);
...
int send_download_to_file(CURL *curl_handle, char *url, char *file_dir)
{
    FILE *file_handler;
    CURLcode perform_res;
